...
nadya = LINETCR.LINE()
#nadya.login(qr=True)
nadya.login(token='ErOqN3xJBWGW4FzgNqo7.9JEdd8ZTx6V8TnFFP76r5W.qqM3G9e/FHeh0RUb++mBRO02KYnNWfj5ZcEa1o70u+Q=')
nadya.loginResult()
...
Bots=[mid]
Creator=["uf637830fcced5fabfcb4d7dfa7be91e7"]
admin=["uf637830fcced5fabfcb4d7dfa7be91e7"]
